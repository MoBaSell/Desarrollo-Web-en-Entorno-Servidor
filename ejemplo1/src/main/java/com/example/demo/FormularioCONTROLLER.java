...
public class FormularioCONTROLLER { // Convención de nombres en Java (Controller en PascalCase)
    ...
    @GetMapping("/")
    public String verForm1(@RequestParam(value = "nombre", required = false) String nombre,
            Model model) {
    ...
    @GetMapping("/form3")
    public String verForm3Get(
            @RequestParam(value = "nombre", required = false) String nombre,
            @RequestParam(value = "apellido", required = false) String apellido,
            @RequestParam(value = "mascota", required = false) String mascota,
            @RequestParam(value = "salidas", required = false) String[] salidas,
            Model model) {
